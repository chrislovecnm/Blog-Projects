...
/**
 * Code Based on {@link EnvironmentStringPBEConfig}
 * <p>
 ...
 * 
 */
public class FileStringPBEConfig 
        extends FilePBEConfig 
     ...
     * </p>
     */
    public FileStringPBEConfig() {
        super();
    }

    public FileStringPBEConfig(String folderName, String token, boolean searchSystemEnvironment) {
        super(folderName,token,searchSystemEnvironment);
    }
